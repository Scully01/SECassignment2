...
<body>
    ...
    <div class="card text-white bg-secondary mb-3" style="max-width: 50%; left: 20px">
        <div class="card-header">Contact Us</div>
            <div class="card-body">
                <h5 class="card-title">Where do I go?</h5>
                <p class="card-text">Need to get in contact with the ABC Gym? Well there are numerous ways to reach us. Check below for more! We pride ourselves on being available as often as possible, and making every customer feel they get our full attention.</p>
            </div>
        </div>

    <div class="card text-white bg-secondary sm-3" style="max-width: 50%; left: 20px">
        <div class="card-body">
    ...
    <h1>Want to enquire about something? Shoot us a message below!</h1>
    <form >
        <div class = "form-row">
            ...
            <div class="form-group col-md-8" style = "left: 20px">
                ...
                <textarea name="messageus" placeholder="Send us a message..."  ></textarea>
            </div>
        </div>

...
function encryption(){
  var hashed_value = document.getElementById('cc-name').value + document.getElementById('cc-number').value + document.getElementById('cc-exp').value + document.getElementById('cc-csc').value;
